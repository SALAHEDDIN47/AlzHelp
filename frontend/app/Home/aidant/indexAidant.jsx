...
export default function IndexAidant() {
  ...
  try {
    ...
    if (data.isFirstLogin) {
      ...
      router.replace("/Home/aidant/addPatient");  // Redirection vers la page d'ajout de patient
    } else {
      setIsFirstLogin(false);
      router.replace("/Home/aidant/Accueil");  // Redirection vers l'accueil de l'aidant
    }
  } catch (error) {
