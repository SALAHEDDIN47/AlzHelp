...
export default function DetailsAidant() {
  ...
  const speakInfo = () => {
    ...
    const msg = `C'est ton aidant : ${parsedAidant.prenomaidant} ${parsedAidant.nomaidant} son âge est ${age} ans. Pour le contacter, vous pouvez cliquer sur l'un des boutons ci-dessus.`;
     Speech.speak(msg, {
